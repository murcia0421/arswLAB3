...
public class ControlFrame extends JFrame {
    ...
    private List<Immortal> immortals; // Lista de inmortales

    private JTextArea output;
    private JLabel statisticsLabel;
    private JScrollPane scrollPane;
    private JTextField numOfImmortals; // Número de inmortales
    ...
    public ControlFrame() {
        ...
        // ___________Botón Start___________
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (immortals != null) {
                    for (Immortal im : immortals) {
                        im.start();// Inicio de inmortales (cada uno es un hilo)
                    }
                }
        ...
        // ___________Botón Pause and check___________
        JButton btnPauseAndCheck = new JButton("Pause and check");
        btnPauseAndCheck.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {

                for (Immortal im : immortals) {
                    im.setPaused(true); // Pausamos hilos
                }
        ...
        // ___________Botón Resume___________
    ...
    public List<Immortal> setupInmortals() {
        ...
        try {
            ...
            // Cambiar LinkedList por CopyOnWriteArrayList
